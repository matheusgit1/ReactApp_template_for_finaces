                ...
                <article className="post">
                  ...
                  <div className="post-wrapper">
                    <div className="post-header">
                      <h1 className="post-title">Gráfico de performance</h1>
                      <ul className="post-meta">
                        <li>perido de tempo</li>
                        <li>
                          <a href="">produto</a> <a href=""></a>
                        </li>
                        <li>
                          <a href="">data</a>
                        </li>
                ...
                <div className="sidebar-right pl-4">
                  <aside className="widget widget-search">
                    <form method="get" onSubmit={this.handleSearch}>
                      <input
                        ...
                        name="searchData"
                        className="form-control"
                        placeholder="pesquisa por palavras chaves"
                        required
                      />
                  ...
                  <aside className="widget widget-categories">
                    ...
                    <ul>
                      <li>
                        <a href="">
                          Nome <span className="float-right">nome do produto</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          Fornecedor <span className="float-right">fornecedor</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          Marca <span className="float-right">marca</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          Em estoque <span className="float-right">estoque</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          Promoção <span className="float-right">sim/não</span>
                        </a>
                      </li>
                    </ul>
                  </aside>
